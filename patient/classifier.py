...
def fit_model(model, model_name, xtrain, xtest, ytrain, ytest):
    print('====================================')
    print('\033[1m' + 'Building Model :: ' + str(model_name)  +'\033[0m')
    print('====================================')
...
data = data.drop(['Mean_Area', 'Mean_Perimeter', 'Worst_Radius', 'Worst_Area', 'Worst_Perimeter','Worst_Texture','Mean_Concavity','Perimeter_SE', 'Area_Se'],axis=1)
...
# print("Before OverSampling, counts of label 'N': {}".format(sum(y_train==1)))
# print("Before OverSampling, counts of label 'R': {} \n".format(sum(y_train==0)))
...
# print("After OverSampling, counts of label 'N': {}".format(sum(y_train_res==1)))
# print("After OverSampling, counts of label 'R': {}".format(sum(y_train_res==0)))


# We begin our best model search by starting with Naive Bayes Algorithm.
...
model = XGBClassifier()
fit_model(model, 'XGBoost', X_train_res, X_test, y_train_res, y_test)
